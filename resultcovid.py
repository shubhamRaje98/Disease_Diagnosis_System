...
class GUI_result:
	...
	def __init__(self, disease_name="", risk_of_covid=0, res=""):
		Result_root = Tk()
		...
		# line 2:
		Result_my_canvas.create_text(170, 200, text="Risk of infection : ", font=("helvetica", 15), fill="black")
		Result_my_canvas.create_text(310, 200, text=str(risk_of_covid) + "%", font=("helvetica", 15), fill="black")
